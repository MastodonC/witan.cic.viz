...
generate_leave_age_histograms_plot <- function(input_dir, output_dir) {
  ...
  ggsave(file.path(output_dir, "leave-age-histograms.png"), width = 8, height = 5)
}

# input_dir <- ''
# output_dir <- ''
#
# generate_leave_age_histograms_plot(input_dir, output_dir)
